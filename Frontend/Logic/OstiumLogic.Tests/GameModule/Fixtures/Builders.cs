    ...
    public static class Builders
    {
        ...
        public static Table BuildTable(Action<TableDef> init = null)
        {
            ...
            return new Table(
                ...
                attackRow: new Row("AttackRow", def.AttackRow != null ? BuildCreatureCard(def.AttackRow) : null),
                defenseRow: new Row("DefenseRow", def.DefenseRow != null ? BuildCreatureCard(def.DefenseRow) : null),
